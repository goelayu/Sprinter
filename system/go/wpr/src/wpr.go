...
const longUsage = `
   ...
   After: Remove the test root CA.
	 ...
	 The archive_file argument is simply a file containing the actual
	 path to the archive itself. We use a file watcher
	 to keep updating this path as the browser loads different pages
		 `
